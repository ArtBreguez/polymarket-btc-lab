...
FEATURES_V29 = [
    ...
    ("ob_imbalance",           "Orderbook","bid_vol / (bid_vol + ask_vol) — CLOB REST snapshot at t~60s"),
    ("ob_depth_ratio",         "Orderbook","bid_depth / ask_depth within ±5¢ of mid — snapshot t~60s"),
    ("ob_total_depth",         "Orderbook","Total bid + ask depth — snapshot t~60s"),
    ("clob_spread_mean",       "CLOB",     "Mean bid-ask spread over t=[0,168s) from WS price_change"),
    ("clob_spread_trend",      "CLOB",     "Linear slope of spread over t=[0,168s)"),
    ("clob_mid_volatility",    "CLOB",     "Std of mid-price changes over t=[0,168s)"),
